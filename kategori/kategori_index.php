...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .btn-secondary{background:transparent;border:1px solid rgba(0,0,0,0.06); color:#333}
  ...
  <title>Kelola Kategori - Kantin Sehat</title>
  </head>
<body>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:12px">
          <a href="kategori_tambah.php" style="text-decoration:none"><button class="btn">Tambah Kategori</button></a>
         <a class="small-btn btn-back" href="../index.php" style="text-decoration:none">Kembali</a>
        </div>

        <?php if (!empty($_SESSION['pesan'])): ?>
          <div style="padding:10px;margin-bottom:12px;border-radius:8px;background:linear-gradient(180deg,#f0fbf6,#f9fff8);border:1px solid rgba(47,143,114,0.12);color:#0f5132">
        ...
        <table id="myTable" style="margin-top:10px;">
          ...
          <tbody>
            ...
            <tr>
              <td><?= $no++; ?></td>
              <td><?= htmlspecialchars($row['tipe_kategori']); ?></td>
              <td><?= htmlspecialchars($row['deskripsi']); ?></td>
              <td>
                 <a class="small-btn btn-edit" href="kategori_edit.php?id=<?= $row['id']; ?>" title="Edit kategori">
                 ...
                 <a class="small-btn btn-delete" href="kategori_hapus.php?id=<?= $row['id']; ?>" 
  ...
  <!-- jQuery (DataTables needs full jQuery) -->
